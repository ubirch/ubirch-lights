/*
 * File:    avrnacl_fast/crypto_sign/ge25519.c
...
static const ge25519_aff ge25519_base_multiples_affine[9] PROGMEM = {
...
void ge25519_scalarmult_base(ge25519_p3 *r, const sc25519 *s)
{
  ...
  for(i=63;i>0;i--)
  {
    ...
    choose_t(&t, base_multiples, b[i-1]);
    ge25519_mixadd2(r, &t);
  }  
}
